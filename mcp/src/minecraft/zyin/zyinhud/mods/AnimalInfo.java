...
public class AnimalInfo
{
	...
	private static String GetHorseAwesomeness(EntityHorse horse)
	{
		...
		double horseSpeed = horse.getEntityAttribute(SharedMonsterAttributes.movementSpeed).getAttributeValue();
		double horseHP = horse.getEntityAttribute(SharedMonsterAttributes.maxHealth).getAttributeValue();
